		...
		<div class="ac-segments">
			...
			<div class="ac-segments__instructions" rel="pointer-segments">
				...
				<div id="ac-segments-instructions" style="display:none;">
					...
					<p>
						<?php _e( 'This can be useful to group your WordPress content based on different criteria and later load the segmented list with a single click.', 'codepress-admin-columns' ); ?>
					</p>
				</div>
			</div>
