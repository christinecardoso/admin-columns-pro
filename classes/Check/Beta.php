...
class Beta
	...
	protected function get_message() {
		return implode( ' ', array(
			...
			sprintf( __( 'If you have feedback or have found a bug, please <a href="#" data-ac-modal="feedback">leave us a message</a>.', 'codepress-admin-columns' ), $this->get_feedback_link() ),
		) );
	}
